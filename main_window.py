...
from data_extract import DataExtractInterface
...
class Window(FramelessWindow):
    ...
    def __init__(self):
        ...
        if sys.platform == "win32":  # taskbar icon
            import ctypes
            ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("Biprogy-H2データベースツール-V1.0")
        ...
        self.dataextractInterface = DataExtractInterface()
        ...
        self.stackWidget.addWidget(self.dataextractInterface)
    ...
    def initNavigation(self):
        self.addSubInterface(self.recognitionInterface, FIF.FIT_PAGE, self.tr("公式認識"))
        self.addSubInterface(self.previewInterface, FIF.COMMAND_PROMPT, self.tr("公式プレビュー"))
        self.addSubInterface(self.historyInterface, FIF.HISTORY, self.tr("歴史"))
        self.addSubInterface(self.dataextractInterface, FIF.PIN, self.tr("データ"))
        self.navigationInterface.addSeparator(1)
        # add item to bottom
    ...
    def addSubInterface(self, w: object, icon, text, position=NavigationItemPosition.TOP):
